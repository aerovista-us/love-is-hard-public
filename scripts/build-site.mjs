...
const assetVersion = '2026-07-29-narrative-audio';
const releaseVersion = 'Public Pilot v1.0';
const publicationDate = 'July 29, 2026';
const lastUpdatedDate = 'July 29, 2026';
...
const navGroups = [
  ...
  },
  {
    label: 'About',
    links: [
      ['pilot.html', 'Public Pilot', 'Release and Feedback'],
...
function feedbackGate(s) {
  const questions = {
    'lesson-01.html': 'Did the difference between feeling, interpretation, claim, request, and boundary become clearer?',
    'lesson-05.html': 'Did the escalation map help you understand sequence without forcing you to choose a villain?',
    'lesson-08.html': 'What is one communication behavior you would now handle differently?',
  };
  const question = questions[s.file];
  if (!question) return '';
  return `<section class="feedback-gate" aria-label="Session feedback"><h2>Quick Checkpoint</h2><p>${question}</p><form data-feedback-form data-session="${s.file}"><div class="feedback-options"><label><input type="radio" name="rating" value="Clear" required /> Clear</label><label><input type="radio" name="rating" value="Mostly clear" /> Mostly clear</label><label><input type="radio" name="rating" value="Still confusing" /> Still confusing</label><label><input type="radio" name="rating" value="Felt one-sided" /> Felt one-sided</label><label><input type="radio" name="rating" value="Felt personally useful" /> Felt personally useful</label></div><label class="feedback-note"><span>Optional note</span><textarea name="note" placeholder="What should be clearer, safer, or more useful?"></textarea></label><button class="btn primary" type="submit">Save Feedback Locally</button><p class="status" data-feedback-status>Feedback is stored only in this browser unless you export it.</p></form></section>`;
}

function sessionActions(s) {
  const nextLabel = s.next?.[1] || 'Continue learning';
  const song = slugForSong(s.audio);
  return `${feedbackGate(s)}<section class="session-actions" aria-label="Session actions"><a class="btn" href="./worksheet.html#${s.workbook}" data-analytics-event="workbook_opened">Practice this</a><a class="btn" href="./tools.html#${s.tool}" data-analytics-event="tool_opened">Use this now</a><a class="btn" href="./player.html?track=${song}" data-analytics-event="audio_started">Hear the pattern</a><button class="btn complete-session" type="button" data-session="${s.file}">Complete Session</button><a class="btn primary" href="./${s.next[0]}">${nextLabel}</a></section>`;
}
...
page('index.html', 'Love Is Hard', `<section class="hero"><div class="hero-inner"><span class="eyebrow">Summit Learning | Communication and Pattern Literacy</span><h1>Love Is Hard: When Conversations Become Tests</h1><p class="lede">Learn to separate feelings from claims, care from proof, boundaries from abandonment, and repair from surrender.</p><div class="cta-row"><a class="btn primary" href="./lesson-01.html" data-analytics-event="course_started">Start the 8-session path</a><a class="btn" href="./tools.html" data-analytics-event="tool_opened">Use a tool now</a><a class="btn" href="./facilitator.html" data-analytics-event="facilitator_opened">Facilitate this</a></div></div></section>
<main id="main"><section><div class="wrap"><div class="section-head"><h2>Choose your starting point</h2><p>Use the program from the beginning, during a hard moment, or as a guided facilitation resource.</p></div><div class="grid three"><article class="card"><h3>I want to understand the full pattern</h3><p>Start the eight-session course from the beginning.</p><a class="inline-link" href="./lesson-01.html" data-analytics-event="course_started">Start Session 1</a></article><article class="card"><h3>I am in a difficult conversation now</h3><p>Use a short script, pause protocol, or boundary builder.</p><a class="inline-link" href="./tools.html" data-analytics-event="tool_opened">Open Immediate Tools</a></article><article class="card"><h3>I am teaching or facilitating this</h3><p>Use the session rhythm, limits, and safety lane.</p><a class="inline-link" href="./facilitator.html" data-analytics-event="facilitator_opened">Open Facilitator Center</a></article></div></div></section>
...
<section class="band"><div class="wrap"><div class="grid three"><article class="card"><h3>Immediate Tools</h3><p>Borrowed War Loop, pause protocol, operating agreement, and glossary terms in one public-safe toolkit.</p><a class="inline-link" href="./tools.html" data-analytics-event="tool_opened">Open tools</a></article><article class="card"><h3>Mobile Workbook</h3><p>Use structured fields for hidden claims, reaction sequence, boundary return, split apology, two truths, and repair gates.</p><a class="inline-link" href="./worksheet.html" data-analytics-event="workbook_opened">Open workbook</a></article><article class="card"><h3>Audio Companion</h3><p>Tracks are grouped by learning role and used as prompts, not proof.</p><a class="inline-link" href="./songs.html" data-analytics-event="audio_started">Open audio lenses</a></article></div></div></section>
<section><div class="wrap"><div class="section-head"><h2>Why this was built</h2><p>Love Is Hard grew from a long-form review of how affection, misunderstanding, reassurance, boundaries, and repair changed over time. The private material remains private. What is published here is the repeatable pattern: the part that may help someone recognize a difficult cycle earlier.</p></div><div class="grid two"><article class="card"><h3>Public Guardrails</h3><p>Evidence was reviewed and consolidated, but private messages, raw recordings outside the cleared player set, and evidence are intentionally withheld from the public version.</p><a class="inline-link" href="./guardrails.html" data-analytics-event="guardrails_opened">Read guardrails</a></article><article class="card"><h3>Facilitator Access</h3><p>Teach pattern literacy with explicit limits, safety lanes, and stop conditions.</p><a class="inline-link" href="./facilitator.html" data-analytics-event="facilitator_opened">Open facilitator center</a></article></div></div></section><section class="band"><div class="wrap"><div class="section-head"><h2>Love Is Hard — Summit Learning ${releaseVersion}</h2><p>Published ${publicationDate}. Last updated ${lastUpdatedDate}. This release is maintained as a public pilot, not final doctrine.</p></div><div class="grid three"><article class="card"><h3>Privacy</h3><p>Workbook notes, completion, feedback, and pilot events are stored locally in your browser. No account or backend analytics are used in this release.</p></article><article class="card"><h3>Feedback</h3><p>Use the checkpoint forms after Sessions 1, 5, and 8, then export pilot data from the release page if you choose to share it.</p><a class="inline-link" href="./pilot.html">Open pilot dashboard</a></article><article class="card"><h3>Correction Channel</h3><p>Report confusing, unsafe, one-sided, or inaccurate material through the project issue tracker.</p><a class="inline-link" href="https://github.com/aerovista-us/love-is-hard-public/issues" target="_blank" rel="noopener">Open GitHub issues</a></article></div></div></section></main>`, 'Start');
...
page('pilot.html', 'Public Pilot', `<main id="main"><section><div class="wrap"><div class="section-head"><span class="tag teal">${releaseVersion}</span><h1>Public Pilot</h1><p>Published ${publicationDate}. Last updated ${lastUpdatedDate}. Use this page to review local pilot signals, export feedback, and understand privacy boundaries.</p></div><div class="grid three"><article class="card"><h3>Privacy Statement</h3><p>This public pilot stores workbook notes, completion progress, anonymous event counts, and checkpoint feedback in this browser only. Nothing is sent to a server by this static site.</p></article><article class="card"><h3>Feedback Link</h3><p>Use the checkpoint forms after Sessions 1, 5, and 8. For corrections that should be public, open a GitHub issue.</p><a class="inline-link" href="https://github.com/aerovista-us/love-is-hard-public/issues" target="_blank" rel="noopener">Open correction channel</a></article><article class="card"><h3>Maintenance Note</h3><p>GitHub Pages currently deploys successfully, but the workflow shows a Node 20-to-24 actions warning. Refresh workflow dependencies before this becomes a failure.</p></article></div><section class="pilot-dashboard" aria-label="Local pilot dashboard"><div class="section-head"><h2>Local Pilot Dashboard</h2><p>This dashboard summarizes only the data stored in your current browser. Export it if a pilot facilitator asks for it.</p></div><div class="grid four" data-pilot-dashboard><article class="card"><h3>Homepage visits</h3><p data-metric="homepage_visit">0</p></article><article class="card"><h3>Course starts</h3><p data-metric="course_started">0</p></article><article class="card"><h3>Workbook opens</h3><p data-metric="workbook_opened">0</p></article><article class="card"><h3>Full completion</h3><p data-metric="full_course_completion">0</p></article></div><div class="grid two" style="margin-top:14px"><article class="card"><h3>Completion by Session</h3><ol class="steps compact" data-session-dashboard></ol></article><article class="card"><h3>Most-used Signals</h3><dl class="metric-list"><dt>Immediate tools</dt><dd data-metric="tool_opened">0</dd><dt>Audio starts</dt><dd data-metric="audio_started">0</dd><dt>Audio completions</dt><dd data-metric="audio_completed">0</dd><dt>Facilitator opens</dt><dd data-metric="facilitator_opened">0</dd><dt>Guardrails opens</dt><dd data-metric="guardrails_opened">0</dd><dt>Feedback submitted</dt><dd data-metric="feedback_submitted">0</dd></dl></article></div><div class="tools" style="margin-top:16px"><button class="tool" type="button" id="exportPilotData">Export Pilot JSON</button><button class="tool" type="button" id="clearPilotData">Clear Pilot Data</button></div><p class="status" id="pilotStatus">Pilot data is local to this browser.</p></section><section class="lesson-block"><div class="section-head"><h2>Short Changelog</h2></div><ol class="steps"><li><strong>v1.0</strong><span>Public pilot release with eight-session path, local progress, feedback gates, workbook, tools, audio companion, facilitator plans, guardrails, and versioned assets.</span></li><li><strong>Maintenance</strong><span>Refresh GitHub Pages workflow dependencies before the current Node actions warning becomes a release blocker.</span></li></ol></section><div class="pager"><a class="btn" href="./index.html">Back: Home</a><a class="btn primary" href="./guardrails.html">Next: Guardrails</a></div></div></section></main>`, 'Public Pilot');

const narrativeHtml = readFileSync('content/private-understanding-narrative.html', 'utf8');

page('guardrails.html', 'Guardrails', `<main id="main"><section><div class="wrap"><div class="section-head"><h1>Public Guardrails</h1><p>The teaching frame was reviewed and consolidated from a private source review, but the underlying messages, recordings outside the cleared player set, and evidence are intentionally withheld from the public version.</p></div><div class="grid"><article class="card"><h3>Evidence Was Reviewed, Not Published</h3><p>The public lesson is grounded in a private review and consolidation process. It does not publish messages, raw exports, ledgers, identifying dates, screenshots, or song lyrics as proof.</p></article><article class="card"><h3>How the Pattern Was Found</h3><p>The early material contained admiration, affection, mythology, and recognition. Later work recorded pressure around words, pace, proof, and uncertainty. The finding was not “one person was the villain”; it was that recognition can become proof pressure, proof can become confession pressure, and confession pressure can become war.</p><a class="small-link" href="./private-understanding.html">Private Understanding Narrative</a></article><article class="card"><h3>What This Model Does Not Prove</h3><p>It does not prove motive, diagnose anyone, excuse harm, or erase accountability. It gives people language for sequence, pressure, boundaries, repair, and public/private separation.</p></article></div><div class="quote" style="margin-top:18px">Teach the pattern, not the person.</div><div class="section-head" style="margin-top:42px"><h2>Want more?</h2><p>Related AeroVista public projects continue the same work from different angles.</p></div><div class="grid"><a class="card" href="https://aerovista-us.github.io/seethetrial/" target="_blank" rel="noopener"><h3>See the Trial</h3><p>A paired release told from two sides of the same fracture: one song holds the boundary, the other reaches through the hurt.</p></a><a class="card" href="https://aerovista-us.github.io/demons/" target="_blank" rel="noopener"><h3>Demons</h3><p>A companion project about difficult internal patterns without flattening people into villains.</p></a><a class="card" href="https://aerovista-us.github.io/Still_Counts/" target="_blank" rel="noopener"><h3>Still Counts</h3><p>A reminder that repair, harm, effort, and impact can all remain real at once.</p></a><a class="card" href="https://aerovista-us.github.io/loopbreaker/" target="_blank" rel="noopener"><h3>Loopbreaker</h3><p>A practical frame for noticing repeated cycles and choosing a different next move.</p></a><a class="card" href="https://aerovista-us.github.io/unheard/" target="_blank" rel="noopener"><h3>Unheard</h3><p>A public space for the cost of not being received, and for better listening.</p></a><a class="card" href="https://aerovista-us.github.io/revolution/" target="_blank" rel="noopener"><h3>Revolution</h3><p>A broader public page for change, refusal, and forward motion.</p></a><a class="card" href="https://aerovista-us.github.io/vday/" target="_blank" rel="noopener"><h3>Vday</h3><p>A nine-insight field manual in music form: energy awareness, control dramas, signal vs noise, cords vs freedom, focus vs fog, and co-creation without control.</p></a></div><div class="pager"><a class="btn" href="./facilitator.html">Back: Facilitator</a><span></span></div></div></section></main>`, 'Guardrails');

page('private-understanding.html', 'Private Understanding Narrative', `<main id="main"><section class="document-view"><div class="wrap narrow"><div class="section-head"><h1>Private Understanding Narrative</h1><section class="narrative-reader" aria-label="Listen to this narrative"><button class="btn narrative-read-btn" id="narrativeReadBtn" type="button">Read it to me</button><div class="themed-player narrative-reader-player" aria-label="Narrative audio controls"><button class="transport-button" id="narrativePlayPause" type="button" aria-label="Play narrative">Play</button><div class="track-controls"><input id="narrativeProgress" type="range" min="0" max="1000" value="0" aria-label="Narrative progress" /><div class="time-row"><span id="narrativeCurrentTime">0:00</span><span id="narrativeDuration">0:00</span></div><label class="volume-row"><span>Vol</span><input id="narrativeVolume" type="range" min="0" max="100" value="100" aria-label="Volume" /></label></div></div><audio id="narrativePlayer" preload="metadata" src="./audio/PN.mp3"></audio></section></div><article class="rich-text" aria-label="Private Understanding Narrative">${narrativeHtml}</article><div class="pager"><a class="btn" href="./guardrails.html">Back: Guardrails</a><span></span></div></div></section></main>`, 'Private Understanding');
