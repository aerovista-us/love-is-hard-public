...
const songs = [
  ...
  ['Repair and Release', 'Paint Me the Villain', 'Session 5', 'Narrator control can turn a reaction into the whole story.', 'What context disappears when one person is assigned the villain role?', 'lesson-05.html'],
...
const playlist = [
  ...
  ['Paint Me the Villain', './audio/paint-me-the-villain.mp3'],
