...
const assetVersion = '2026-07-29-narrative-audio-narrative-player';
...
page('private-understanding.html', 'Private Understanding Narrative', `<main id="main"><section class="document-view"><div class="wrap narrow"><div class="section-head"><h1>Private Understanding Narrative</h1></div><div class="narrative-shell"><section class="themed-player narrative-reader" aria-label="Listen to this narrative"><button class="transport-button narrative-read-btn" id="narrativeReadBtn" type="button" aria-pressed="false">Read it to me</button><div class="track-controls"><input id="narrativeProgress" type="range" min="0" max="1000" value="0" aria-label="Narrative progress" /><div class="time-row"><span id="narrativeCurrentTime">0:00</span><span id="narrativeDuration">0:00</span><label class="volume-row" title="Volume"><span>Vol</span><input id="narrativeVolume" type="range" min="0" max="100" value="100" aria-label="Volume" /></label></div></div><audio id="narrativePlayer" preload="metadata" src="./audio/PN.mp3"></audio></section><article class="rich-text" aria-label="Private Understanding Narrative">${narrativeHtml}</article></div><div class="pager"><a class="btn" href="./guardrails.html">Back: Guardrails</a><span></span></div></div></section></main>`, 'Private Understanding');
